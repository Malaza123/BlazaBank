...
import com.blazabank.helpers.Token;
import com.blazabank.models.User;
import com.blazabank.repository.UserRepository;
...
public class AuthController {
    ...
    public String login(@RequestParam("email")String email,
        ...
        if(getEmailInDatabase != null ){
            ...
            model.addAttribute("error", "Something went wrong please contact support at info@blazabank.com");
            return "error";
        }
        // Check If Email Exists.
