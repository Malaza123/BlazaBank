...
<body class="d-flex align-items-center">
    ...
    <div id="sample-text-card" class="card col-6 bg-transparent border-0">
        ...
        <div class="card-body">
           ...
           <!-- Card Text -->
           <p class="card-text">
               Welcome to Blaza Bank, your trusted partner for secure and convenient online banking services. With our user-friendly platform and advanced technology,
               we strive to provide you with a seamless banking experience right at your fingertips. </p>
           <!-- End Of Card Text -->
